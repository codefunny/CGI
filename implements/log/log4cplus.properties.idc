#配置文件（其它日志级别配置相同）：
log4cplus.rootLogger=WARN, DEBUG_MSGS, ERROR_MSGS, WARN_MSGS
...
#设置输出日志路径
log4cplus.appender.DEBUG_MSGS.File=/data/log/debug.log
...
#设置输出日志路径
log4cplus.appender.ERROR_MSGS.File=/data/log/error.log
...
#设置输出日志路径
log4cplus.appender.WARN_MSGS.File=/data/log/warn.log
