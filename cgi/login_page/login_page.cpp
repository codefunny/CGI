...
//        All rights reserved
//
//        filename : login_page.cpp
//        description : 登录页的CGI入口
//
...
{
    string strCGIName = "/login_page";
    string strCsFile = "login_page.cs";
    ...
    do
    {
        if (user::CheckLandingState(oRequest.strUserID, oRequest.strUserKey))
        {
            ...
            //FCGI_printf("Location: http://huishoubao.com.cn/home_page\r\n");
            string strLocation = "Location: http://" + DOMAIN_NAME + "/home_page\r\n";
