...
//        All rights reserved
//
//        filename : api-raw_products.cpp
//        description : 没有登录态时获取产品列表的CGI入口
//
...
{
    string strCGIName = "/api/raw_products";
    ...
    if (logic::GetProductList("", "", true, ::atoi(oRequest.strChannel.c_str()), oRequest.oFilter, jsonOutput))
    {
