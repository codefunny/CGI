...
static bool ParseCgi(CRequest& oRequest)
{
    ...
    if (!oRequest.strPostData.empty())
    {
        ...
        DEBUG("pid is : " + oRequest.strPid + ", channel is : " + oRequest.strChannel + ", selects is : " + oRequest.strSelects + ", creategood is : " + oRequest.strCreategood);
    }
